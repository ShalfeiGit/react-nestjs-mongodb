...
export class Init1705803515918 implements MigrationInterface {
    name = 'Init1705803515918'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`article\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(200) NOT NULL, \`content\` varchar(2000) NOT NULL, \`tag\` enum ('frontend', 'backend', 'marketing', 'graphic', 'devops', 'video', 'tools', 'mobile', 'gamedev', 'cms', 'blockchain', 'Quality assurance', 'security') NOT NULL, \`createdAt\` bigint NULL, \`updatedAt\` bigint NULL, \`likes\` int NOT NULL DEFAULT '0', \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
