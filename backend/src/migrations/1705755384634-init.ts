...
export class Init1705755384634 implements MigrationInterface {
    name = 'Init1705755384634'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`article\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(200) NOT NULL, \`content\` varchar(2000) NOT NULL, \`tag\` enum ('frontend', 'backend', 'marketing', 'graphic', 'devops') NOT NULL, \`createdAt\` bigint NULL, \`updatedAt\` bigint NULL, \`likes\` int NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
